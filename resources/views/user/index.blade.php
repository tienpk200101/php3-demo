                    ...
                    <div class="col-xs-12" style="text-align:center;">
                        <div class="form-group">
                            ...
                            <a href="{{ url('/user') }}" class="btn btn-default btn-sm "><i class="fa fa-remove"></i>
                                Clear </a>
                            <a href="{{ route('route_Backend_Sinhvien_Add') }}" class="btn btn-info btn-sm"><i class="fa fa-user-plus" style="color:white;"></i>
                                Add new</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="{{url('/sinhvien/detail/'.$l->id)}}" style="white-space:unset;text-align: justify;">{{$l->tensv}}<i class="fa fa-edit"></i></a></td>
                                <td class="text-center"><img src="{{asset('storage/'.$l->anh)}}" width="100px" /></td>
                                <td class="text-center">{{$l->khoa}}</td>
                                <td class="text-center">{{$l->tuoi}}</td>
